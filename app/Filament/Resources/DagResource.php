...
use App\Filament\Resources\DagResource\Pages;
use App\Filament\Resources\DagResource\RelationManagers;
...
class DagResource extends AdviceResource
{
    protected static ?string $model = Advice::class;
    protected static ?string $modelLabel = 'DAG';
    protected static ?string $navigationLabel = "DAG";
                ...
                Forms\Components\Card::make()
                    ->schema([
                        Forms\Components\Select::make('advice_type')
                            ...
                            ->columns(3)
                            ->default(function () {
                                return Advicetype::where('advice_type_name', 'DAG')->first()->id;
                            }),
                        ...$labelColumns
                    ]),
    ...
    {
        return [
            'index' => Pages\ListDags::route('/'),
            'create' => Pages\CreateDag::route('/create'),
            'edit' => Pages\EditDag::route('/{record}/edit'),
        ];
    }
