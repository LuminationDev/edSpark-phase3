...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'menubar' => true,
            'plugins' => 'advlist anchor autoresize codesample code directionality emoticons fullscreen hr image imagetools link lists paste media table wordcount',
            'toolbar' => 'undo redo removeformat | formatselect | bold italic | alignjustify alignleft aligncenter alignright lineheight | numlist bullist | forecolor backcolor | blockquote table toc hr | image link media code anchor codesample emoticons | wordcount',
