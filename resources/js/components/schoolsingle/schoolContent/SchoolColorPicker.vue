...
<template>
    <div class="schoolColorPickerContainer max-w-xl w-1/2 bg-slate-100 flex flex-col text-center border-2">
        ...
        <div class="flex flex-row flex-wrap justify-center">
            ...
            <div
                ...
                :key="index"
                class="colorBox w-12 h-12 m-1 flex-wrap hover:ring-2"
