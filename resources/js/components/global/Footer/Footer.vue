...
<template>
    <div class="bg-main-navy flex flex-col mt-20 px-10 py-10 text-white w-full">
        <!--        Footer HyperLinks Row -->
        <div class="FooterHyperLinks flex justify-around flex-row flex-wrap mb-10 w-full">
            <div class="ContactUs flex flex-col mt-4 w-1/2 lg:!w-auto">
                <div class="FooterHeading font-bold text-xl">
                    Contact Us
                </div>
            ...
            <div class="FeedbackAndComplaints flex flex-col mt-4 w-1/2 lg:!w-auto">
                <div class="FooterHeading font-bold text-xl">
