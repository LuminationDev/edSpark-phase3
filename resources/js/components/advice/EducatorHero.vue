    ...
    <div class="EducatorHeroContainer">
        ...
        >
            <div class="col-span-5">
                <h1 class="capitalize font-semibold pb-8 text-2xl text-white md:!text-3xl lg:!text-4xl">
            ...
            <div class="col-span-3 flex justify-start items-start relative md:!items-end md:!justify-end">
                <AdviceEducatorsIcon
                    class="
                        absolute
                        -right-28
