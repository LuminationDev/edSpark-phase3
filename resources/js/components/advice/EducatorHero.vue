...
<template>
    <div class="EducatorHeroContainer">
        <div
            class="bg-gradient-to-r from-[#002858] via-[#0B7342] to-[#81BFA2] mt-20 py-6 px-[48px] grid grid-cols-8 mx-huge">
            ...
            <div class="col-span-3 relative flex justify-end items-end">
                <AdviceEducatorsIcon class="absolute right-12 -top-20" />
                <GenericButton :callback="() => router.push('browse/advices')"
