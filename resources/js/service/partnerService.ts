...
export const partnerService = {
    ...
    updatePartnerContent: async (partnerId: number, currentUserId: number, content: string, introduction: string, motto: string, logo: any, coverImage): Promise<AxiosResponse<any>> => {
