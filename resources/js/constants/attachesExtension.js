 ...
 */
export default class CustomAttachesTool {
    /**
    ...
    constructor({data, config, api, readOnly}) {
        ...
        this.config = {
            ...
            types: config.types || '*',
            buttonText: config.buttonText || 'Select video file to upload',
    ...
    onUpload(response) {
        ...
        try {
            if (body.success && body.file !== undefined && !isEmpty(body.file)) {
                this.data = {
                    file: body.file,
                    title: body.file.title || 'video.mp4',
                };
    ...
    appendFileIcon(file) {
        ...
        if (extensionColor) {
            console.log('extension color is ' + extensionColor)
     ...
     */
    get data() {
        // console.log("TOOLBOX DATA", this._data);
        return this._data;
    }
