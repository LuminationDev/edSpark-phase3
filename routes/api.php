...
//Route::middleware('api')->group(function() {
    ...
    Route::post('addOrEditEventEMSLink', [EventController::class, 'addOrEditEventEMSLink']);
    Route::get('fetchEventEMSLink/{event_id}', [EventController::class, 'fetchEventEMSLink']);
